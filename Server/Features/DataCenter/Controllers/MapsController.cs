...
public class MapsController : ControllerBase
{
    ...
    /// <summary>
    /// </summary>
    public MapsController(WorldServicesFactory worldServicesFactory)
    {
    ...
    {
        MapsService worldService = await _worldServicesFactory.CreateMapsServiceAsync(gameVersion, cancellationToken);
    ...
    {
        WorldGraphService worldService = await _worldServicesFactory.CreateWorldGraphServiceAsync(gameVersion, cancellationToken);
